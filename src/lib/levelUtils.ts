...
const LEVEL_CONFIGS: Record<LevelCategory, LevelConfig> = {
  ...
  college: {
    ...
    secondaryCtaPath: '/aide-devoirs',
    priorityTools: [
      { path: '/ressources', badge: 'Brevet' },
      { path: '/aide-devoirs', badge: 'Devoirs' },
  ...
  lycee: {
    ...
    priorityTools: [
      ...
      { path: '/aide-devoirs', badge: 'Dissertation' },
  ...
  superieur: {
    ...
    priorityTools: [
      ...
      { path: '/aide-devoirs', badge: 'Analyse' },
  ...
  adapte: {
    ...
    priorityTools: [
      { path: '/aide-devoirs',      badge: 'Mode ULIS\u2005💚' },
