          ...
          >
            {file.type.startsWith('image/') ? (
              <div className="h-10 w-10 rounded border overflow-hidden shrink-0 bg-muted flex items-center justify-center">
                <img src={file.preview} alt={file.name} width={40} height={40} className="object-cover w-full h-full" />
              </div>
            ) : (
            ...
            <div className="shrink grow flex flex-col items-start truncate">
              ...
              {file.errors.length > 0 ? (
                ...
                <p className="text-sm text-muted-foreground leading-relaxed">Uploading file...</p>
              ) : !!fileError ? (
                ...
                <p className="text-sm text-muted-foreground leading-relaxed">{formatBytes(file.size, 2)}</p>
              )}
            </div>
