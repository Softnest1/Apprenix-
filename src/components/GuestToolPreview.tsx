...
const TOOL_META: Record<string, ToolMeta> = {
  '/aide-devoirs': {
    ...
    cta: 'Accéder à l\'Aide aux devoirs',
  ...
  '/scanner': {
    ...
    subtitle: 'Prends en photo ton exercice — l\'OCR lit le texte et t\'explique la méthode.',
          ...
          <nav aria-label="Fil d'Ariane" className="mb-7">
            <ol className="flex items-center gap-1 flex-wrap">
              ...
              <li>
                <Link
                  to="/"
                  className="inline-flex items-center gap-1.5 px-3 py-1.5 rounded-full text-xs font-medium bg-white/10 text-white/70 border border-white/15 hover:bg-white/20 hover:text-white transition-all duration-150"
                >
                  <svg className="w-3 h-3 shrink-0" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5" aria-hidden="true"><path d="M3 9l9-7 9 7v11a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2z"/><polyline points="9 22 9 12 15 12 15 22"/></svg>
                  Accueil
                </Link>
              </li>
              {/* Séparateur */}
              ...
              <li>
                <span
                  aria-current="page"
                  className="inline-flex items-center gap-1.5 px-3 py-1.5 rounded-full text-xs font-semibold bg-white/20 text-white border border-white/25"
                >
                  {title}
                </span>
              </li>
              {/* Badge Démo */}
              <li className="ml-1">
                <span className="inline-flex items-center gap-1 px-2.5 py-1 rounded-full text-[10px] font-bold bg-white text-primary border border-white/80 shadow-sm shadow-black/10">
        ...
        <div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-3">
            {[
              ...
              { path: '/aide-devoirs',       emoji: '🧠', label: 'Aide aux devoirs',  desc: 'Fiches méthode — toutes matières' },
