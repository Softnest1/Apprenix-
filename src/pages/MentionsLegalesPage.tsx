import { AlertTriangle, ChevronRight, Home, ShieldCheck } from 'lucide-react';
  ...
  <div className="max-w-5xl mx-auto py-4 min-w-0">
    ...
    <nav aria-label="Fil d'Ariane" className="mb-6">
      <ol className="flex items-center gap-1 flex-wrap">
        <li>
          <Link to="/" className="inline-flex items-center gap-1.5 px-3 py-1.5 rounded-full text-xs font-medium bg-muted text-muted-foreground border border-border hover:bg-primary/8 hover:text-primary hover:border-primary/20 transition-all">
            <Home className="w-3 h-3 shrink-0" aria-hidden="true" />
            Accueil
          </Link>
        </li>
        <li aria-hidden="true"><ChevronRight className="w-3.5 h-3.5 text-muted-foreground/40 mx-0.5" /></li>
        <li>
          <span aria-current="page" className="inline-flex items-center px-3 py-1.5 rounded-full text-xs font-semibold bg-primary/8 text-primary border border-primary/20">
            Mentions légales
          </span>
        </li>
      </ol>
    ...
    <Section title="4. Propriété intellectuelle">
      ...
      <p>
        Les outils pédagogiques (aide aux devoirs, flashcards, ressources, formules, etc.) sont mis à
