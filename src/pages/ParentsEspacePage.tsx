...
const ParentsEspaceContent: React.FC = () => {
  ...
  return (
    <div className="min-h-dvh bg-gradient-to-br from-primary/5 via-background to-background flex flex-col">
      ...
      {/* ── Header Apprenix ───────────────────────────────────────────────── */}
      <header
        className="w-full border-b border-border bg-background/95 backdrop-blur-sm sticky top-0 z-40 print:hidden"
      ...
      >
        <div className="max-w-4xl mx-auto px-3 h-14 flex items-center gap-2">
          ...
          {/* Actions — min 44×44px pour conformité WCAG touch targets */}
          <div className="flex items-center gap-0.5 shrink-0">
            <button
              type="button"
              onClick={toggleTheme}
              className="w-11 h-11 min-w-[44px] min-h-[44px] flex items-center justify-center rounded-xl text-muted-foreground hover:bg-accent hover:text-accent-foreground transition-colors"
            ...
            <Link
              to="/"
              className="flex items-center gap-1.5 h-11 min-h-[44px] px-3 rounded-xl text-xs font-medium text-muted-foreground hover:bg-accent hover:text-accent-foreground transition-colors"
            ...
            <div className="space-y-5">
              ...
              <div className="flex flex-col md:flex-row md:items-center justify-between gap-3 print:flex-row">
                <div className="min-w-0">
                  <h2 className="text-xl md:text-2xl xl:text-3xl font-extrabold text-balance truncate">
              ...
              <Card className="print:hidden">
                ...
                <CardContent>
                  ...
                  <div className="grid grid-cols-2 md:grid-cols-4 gap-2.5">
                    {[
                      { icon: BookOpen,      label: 'Aide aux devoirs',   desc: 'Explications pas-à-pas par nos enseignants',     color: 'text-primary'  },
