...
const TOOL_CATEGORIES = [
  ...
  { id: 'communaute',  label: 'Communauté & Partage',     icon: Users,      color: 'text-chart-3', bg: 'bg-chart-3/10', border: 'border-chart-3/20', desc: 'Apprendre ensemble, progresser plus vite' },
] as const;
type ToolCategoryId = typeof TOOL_CATEGORIES[number]['id'];

// 20 outils pédagogiques — regroupés par catégorie pour meilleure lisibilité
const TOOLS: { path: string; icon: React.ElementType; label: string; desc: string; color: string; bg: string; category: ToolCategoryId }[] = [
  // ── Aide & Recherche ──────────────────────────────────────────────────────
  { path: '/aide-devoirs',        icon: Brain,         label: 'Aide aux devoirs',        desc: 'Fiches méthode pas-à-pas + ressources vérifiées, toutes matières',      color: 'text-chart-1', bg: 'bg-chart-1/10', category: 'aide'        },
  ...
  { path: '/motivation',          icon: Trophy,        label: 'Motivation & XP',         desc: 'Badges, streak quotidien et suivi de progression gamifiée',             color: 'text-chart-5', bg: 'bg-chart-5/10', category: 'performance' },
  // ── Communauté & Partage ──────────────────────────────────────────────────
  { path: '/communaute',          icon: Users,         label: 'Forum d\'entraide',       desc: 'Pose tes questions, réponds aux camarades, gagne des XP',               color: 'text-chart-3', bg: 'bg-chart-3/10', category: 'communaute'  },
  { path: '/visio',               icon: Globe,         label: 'Classe virtuelle',        desc: 'Cours en visioconférence avec un enseignant ou en groupe',              color: 'text-chart-3', bg: 'bg-chart-3/10', category: 'communaute'  },
  { path: '/chansons-educatives', icon: Sparkles,      label: 'Chansons éducatives',     desc: 'Mémorise les leçons en musique — anglais, histoire, maths…',            color: 'text-chart-3', bg: 'bg-chart-3/10', category: 'communaute'  },
  { path: '/trouver-enseignant',  icon: GraduationCap, label: 'Trouver un enseignant',   desc: 'Mise en relation avec des profs certifiés — 100 % gratuit',             color: 'text-chart-3', bg: 'bg-chart-3/10', category: 'communaute'  },
];
...
const HOW_IT_WORKS = [
  ...
  },
  {
    ...
    desc: "Tapez votre question en français, collez un extrait de cours, ou photographiez directement un exercice avec votre téléphone. La plateforme analyse le contenu et affiche les fiches méthode correspondantes en quelques secondes.",
    color: 'text-chart-3',
    bg: 'bg-chart-3/10',
    bar: 'bg-chart-3',
    details: [
  ...
  },
  {
    step: '03',
    icon: Sparkles,
    title: 'Des explications pas-à-pas, sans faire à votre place',
  ...
  },
  {
    ...
    bar: 'bg-chart-2',
    details: [
      'Création de cartes depuis une explication ou un cours',
    ...
    <div className="min-w-0 space-y-6 md:space-y-10 2xl:space-y-14">
        ...
        <div className="relative z-10 max-w-screen-2xl mx-auto flex flex-col md:flex-row md:items-center px-5 py-12 md:px-12 md:py-16 lg:px-16 lg:py-20 xl:px-20 xl:py-24 2xl:px-24 2xl:py-28 gap-10 lg:gap-16 xl:gap-24">
          ...
          <div className="flex flex-col items-center md:items-start text-center md:text-left flex-1 min-w-0">
            ...
            <ul className="flex flex-col gap-2.5 mb-8 w-full md:w-auto" aria-label="Avantages Apprenix">
              {[
                { icon: Sparkles,      text: '20 outils pédagogiques alignés sur le programme officiel' },
              ...
              <div className="p-4 md:p-5 flex flex-col gap-3 flex-1">
                ...
                <div className="flex-1">
                  ...
                  <p className="text-xs md:text-sm text-muted-foreground text-pretty leading-relaxed line-clamp-2 md:line-clamp-none">
                    20 outils gratuits : flashcards, quiz, carte mentale, scanner, planning…
                  </p>
                </div>
        ...
        <div className="flex items-start justify-between mb-5 gap-3">
          <div className="section-divider pt-3 flex-1 min-w-0">
            ...
            <h2 className="text-display text-xl md:text-3xl xl:text-4xl text-foreground text-balance mt-1">
              <span className="gradient-text">20 outils</span> — tous gratuits, tous utiles
            </h2>
      ...
      >
        ...
        <div className="relative">
          ...
          <p className="text-base md:text-lg xl:text-xl text-muted-foreground mb-8 text-pretty leading-relaxed max-w-lg mx-auto">
            20 outils pédagogiques alignés sur les programmes français — accessibles dès maintenant, sans créer de compte.
          </p>
      ...
      <nav aria-label="Explorer Apprenix" className="border-t border-border/30 pt-5">
        ...
        <div className="flex flex-wrap gap-x-5 gap-y-2">
          {[
            { label: 'Aide aux devoirs gratuite',  to: '/aide-devoirs'              },
    ...
    <div className="min-w-0 space-y-5 md:space-y-7">
      ...
      <section className="relative rounded-2xl overflow-hidden bg-hero-pattern animate-fade-up" aria-label={`Tableau de bord de ${firstName}`}>
        ...
        <div className="relative z-10 px-5 py-5 md:px-8 md:py-7">
          ...
          <h2 className="text-display text-xl md:text-3xl xl:text-4xl text-white mb-1.5 text-balance leading-tight animate-fade-up delay-200">
      ...
      <section aria-label="Tous les outils">
        <div className="flex items-center justify-between mb-4">
          ...
          <Badge variant="secondary" className="text-xs shrink-0 font-semibold">20 gratuits</Badge>
        </div>
