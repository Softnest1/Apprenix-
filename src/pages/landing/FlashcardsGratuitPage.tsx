  ...
  return (
    <>
      <SEO
        ...
        description="Crée tes flashcards gratuitement ou choisis parmi nos bibliothèques de révision. Algorithme de répétition espacée (SRS), méthode Leitner, disponible sur mobile. Sans pub."
        keywords={[
          ...
          "flashcards révision","révision efficace","apprendre flashcards",
        ]}
        ogType="website"
      />
