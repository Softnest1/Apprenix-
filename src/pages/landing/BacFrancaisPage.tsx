    ...
    <>
      ...
      <main className="min-h-dvh bg-background">
        ...
        <LandingHero
          ...
          ctaPrimary={{ label: 'Fiches méthode bac français', to: '/aide-devoirs', icon: Sparkles }}
            ...
            <ol className="space-y-4">
              {[
                  ...
                  link: "/ressources", cta: "Fiches de révision" },
                {
                  ...
                  link: "/aide-devoirs", cta: "Méthode & exercices guidés" },
                {
                  ...
                  link: "/aide-devoirs", cta: "Préparer l'entretien oral" },
              ].map((item) => (
