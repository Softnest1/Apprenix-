  ...
  return (
    <>
      <SEO
        ...
        description="Prépare le Brevet de Maths 2026 gratuitement : calcul, algèbre, géométrie, statistiques. Fiches méthode étape par étape, formules, calculatrice scientifique. Zéro pub."
        keywords={[
              ...
              {[
                {
                  ...
                  link: "/aide-ia", cta: "Exercices calcul" },
                {
