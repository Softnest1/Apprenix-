...
const METHODES_PRINCIPALES = [
  ...
  },
  {
    ...
    lien: '/aide-devoirs', cta: "Pratiquer avec l'assistant",
  ...
  return (
    <>
      <SEO
        ...
        description="Les meilleures méthodes de travail pour lycéens et collégiens : Pomodoro, Feynman, répétition espacée, Deep Work. Techniques validées par les neurosciences."
      ...
      <div className="min-w-0 space-y-10">
        ...
        <nav aria-label="Autres ressources organisation scolaire" className="flex flex-wrap gap-2">
          {[
            ...
            { to: '/aide-devoirs',          label: 'Assistant — toutes matières' },
