      ...
      <Tabs defaultValue="resumes">
        ...
        <TabsContent value="resumes" className="space-y-4">
            ...
            <Card className="shadow-card">
              <CardContent className="p-6 text-center space-y-4">
                ...
                <div className="flex flex-col md:flex-row gap-2 justify-center">
                  <Button size="sm" className="h-9 text-xs" onClick={() => { navigate('/aide-devoirs'); addActivity('Résumé → aide devoirs'); }}>
          ...
          <div className="flex items-center justify-between gap-3 rounded-xl border border-primary/25 bg-primary/5 p-3">
            ...
            <Button size="sm" className="h-8 text-xs shrink-0" onClick={() => { addActivity('Lien Aide devoirs'); navigate('/aide-devoirs'); }}>
              Aide aux devoirs
            </Button>
          </div>
        </TabsContent>
          ...
          {(FICHES_PAR_MATIERE[selectedSubject] ?? []).length > 0 ? (
            ...
            <Card className="shadow-card">
              <CardContent className="p-6 text-center space-y-4">
                ...
                <div className="flex flex-col md:flex-row gap-2 justify-center">
                  <Button size="sm" className="h-9 text-xs" onClick={() => { navigate('/aide-devoirs'); addActivity('Fiches → aide devoirs'); }}>
                    Poser une question à un enseignant
                  </Button>
